...
export default function WomenPage() {
  ...
  (product) => product.gender?.toLowerCase() === "women"
    ...
    const latestArrivals = womenProducts.filter(
    ...
    if (loading) {
        return (
            <div className="flex min-h-screen items-center justify-center">
                <p className="text-gray-500">Loading women's products...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="px-6 pb-8 pt-12 text-center">
                ...
                <p className="mx-auto mt-3 max-w-xl text-gray-500">
                    Discover our latest collection of stylish sunglasses for women.
                </p>
